...
namespace Gato.Game
{
    class Poli : Persona
    {
        ...
        void Start()
        {
            ...
            ////TODO: VAMOS A LOGUEAR ALGO
            //tiempoDelta += Time.deltaTime;

            //if (
            //    (tiempoDelta >= 2f) && (GetComponent<Poli>().Nombre.Equals("Poli_0"))
            //   )
            //{
            //    //Debug.Log("Logueando desde Poli cada: " + tiempoDelta);
            //    Debug.Log("Nombre: " + GetComponent<Poli>().Nombre);
            //    Debug.Log("Estamos viendo: Start()");
            //    Debug.DrawLine(transform.position, new Vector3(0, 55, 0), Color.magenta, 10);


            //    tiempoDelta = 0;
            //}
            ////TODO: VAMOS A LOGUEAR ALGO .END
            TomarDaño(0f);
        ...
        void Update()
        {
            ...
            if (EstaVivo())
            {
                ...
                if (!alerta)
                {
                    ...
                    //    //Debug.Log("Logueando desde Poli cada: " + tiempoDelta);
                    //    Debug.Log("Nombre: " + GetComponent<Poli>().Nombre);
                    //    Debug.Log("Estamos viendo: IrAUnSitio();");
                    //    Debug.DrawLine(transform.position, new Vector3(0, 55, 0), Color.magenta, 10);
        ...
        private void IrAUnSitio()
        {
            ...
            //    //Debug.Log("Logueando desde Poli cada: " + tiempoDelta);
            //    Debug.Log("Nombre: " + GetComponent<Poli>().Nombre);
            //    Debug.Log("Estamos viendo: navegacionaIA.destination = unTrabajo;");
            //    Debug.DrawLine(transform.position, new Vector3(0, 55, 0), Color.magenta, 10);
        ...
        {            
            ...
            refGeneradorPoblacional.CrearZombieEnQueEra(pos, 6);
