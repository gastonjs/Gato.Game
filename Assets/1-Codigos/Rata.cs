...
namespace Gato.Game { 
    class Rata : Enemigo
    {
        ...
        public Transform posMoneda;
        public float tiempoMonedas;
        ...
        private void FixedUpdate()
        {
            ...
            if (
                (deltaTime >= tiempoMonedas) && ( !estado.Equals("quieto")) && (!estado.Equals("buscar"))
               )
            {
                Instantiate(Moneda, posMoneda.position, Quaternion.identity);
