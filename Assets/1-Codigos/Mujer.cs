...
namespace Gato.Game
{
    class Mujer : Persona
    {
        ...
        public GameObject Salud1;
        public Transform posSalud1;
        public float tiempoSalud1;
        ...
        private void FixedUpdate()
        {
            ...
            if (
                (deltaTime >= tiempoSalud1) /*&& (!estado.Equals("quieto")) && (!estado.Equals("buscar"))*/
               )
            {
                Instantiate(Salud1, posSalud1.position, Quaternion.identity);
        ...
        {            
            ...
            refGeneradorPoblacional.CrearZombieEnQueEra(pos, 3);
